...
MOONBOOK_MINIO_USE_SSL="${MOONBOOK_MINIO_USE_SSL:-false}"
MOONBOOK_ADMIN_ORIGIN="${MOONBOOK_ADMIN_ORIGIN:-http://localhost:8080}"
MOONBOOK_READER_ORIGIN="${MOONBOOK_READER_ORIGIN:-http://localhost:8081}"
export MOONBOOK_POSTGRES_HOST MOONBOOK_POSTGRES_PORT MOONBOOK_REDIS_ADDR
export MOONBOOK_MINIO_ENDPOINT MOONBOOK_MINIO_BUCKET_URL MOONBOOK_MINIO_USE_SSL MOONBOOK_ADMIN_ORIGIN MOONBOOK_READER_ORIGIN
