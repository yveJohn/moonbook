...
variables='${POSTGRES_HOST_PORT} ${POSTGRES_DB} ${POSTGRES_USER} ${POSTGRES_PASSWORD} ${REDIS_HOST_PORT} ${REDIS_PASSWORD} ${MINIO_API_HOST_PORT} ${MINIO_ROOT_USER} ${MINIO_ROOT_PASSWORD} ${MINIO_BUCKET} ${MOONBOOK_SERVER_PORT} ${MOONBOOK_JWT_SIGNING_KEY} ${MOONBOOK_METRICS_TOKEN}'
