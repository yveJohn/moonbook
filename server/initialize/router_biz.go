...
func initBizRouter(routers ...*gin.RouterGroup) {
	...
	payment.RegisterRoutes(publicGroup, payment.NewService(payment.SQLRepository{DB: db, Invites: readerInvites}, os.Getenv("MOONBOOK_EPUSDT_PID"), os.Getenv("MOONBOOK_EPUSDT_SECRET")))
	...
	adminrechargeorder.RegisterRoutes(privateGroup, adminrechargeorder.NewService(adminrechargeorder.SQLRepository{DB: db, Invites: readerInvites}, transactor, readerAccounts))
