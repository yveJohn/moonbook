...
func (r SQLRepository) Process(ctx context.Context, c Callback) error {
	return r.process(ctx, nil, c)
}

func (r SQLRepository) ProcessAttempt(ctx context.Context, attemptID int64, c Callback) error {
	if attemptID <= 0 {
...
func (r SQLRepository) process(ctx context.Context, attemptID *int64, c Callback) error {
