...
func TestReaderMeHTTPContractSnapshotsAndBoundaries(t *testing.T) {
	...
	tests := []struct {
		...
		{"add shelf", http.MethodPost, "/reader/me/bookshelf/9007199254740993", "", `{"code":200,"msg":"操作成功","data":{"bookshelfId":"9223372036854775807","bookId":"9007199254740993","bookName":"边界作品","authorName":"边界作者","lastChapterId":"9223372036854775806","lastChapterName":"最后一章","lastReadTime":"2026-08-15T01:02:03Z"}}`},
		{"remove shelf", http.MethodDelete, "/reader/me/bookshelf/9223372036854775807", "", `{"code":200,"msg":"操作成功","data":true}`},
		{"list likes", http.MethodGet, "/reader/me/likes", "", `{"code":200,"msg":"查询成功","data":[{"likeId":"9223372036854775807","bookId":"9007199254740993","bookName":"边界作品","authorName":"边界作者","bookDesc":"简介","categoryCode":"fantasy","categoryName":"奇幻","wordCount":123,"likeCount":7,"likedAt":"2026-08-15T01:02:03Z"}]}`},
		...
		{"create feedback", http.MethodPost, "/reader/me/feedbacks", `{"content":"  契约反馈  "}`, `{"code":200,"msg":"操作成功","data":{"id":"9223372036854775807","content":"契约反馈","status":"pending","replyContent":null,"replyTime":null,"createTime":"2026-08-15T01:02:03Z"}}`},
		{"empty feedback page", http.MethodGet, "/reader/me/feedbacks?pageNum=0&pageSize=1000", "", `{"code":200,"msg":"查询成功","rows":[],"total":0}`},
		{"list history", http.MethodGet, "/reader/me/history", "", `{"code":200,"msg":"查询成功","data":[{"historyId":"9223372036854775807","bookId":"9007199254740993","chapterId":"9223372036854775806","chapterNo":2,"chapterName":"第二章","positionType":"page","positionValue":3,"progressPercent":"50.00","lastReadTime":"2026-08-15T01:02:03Z"}]}`},
		{"missing history is null", http.MethodGet, "/reader/me/history/9007199254740993", "", `{"code":200,"msg":"查询成功","data":null}`},
		{"update history", http.MethodPut, "/reader/me/history/9007199254740993", `{"chapterId":"9223372036854775807","chapterNo":2,"positionType":"page","positionValue":4,"progressPercent":"12.5"}`, `{"code":200,"msg":"操作成功","data":{"historyId":"9223372036854775807","bookId":"9007199254740993","chapterId":"9223372036854775807","chapterNo":2,"chapterName":"第二章","positionType":"page","positionValue":4,"progressPercent":"12.50","lastReadTime":"2026-08-15T01:02:03Z"}}`},
