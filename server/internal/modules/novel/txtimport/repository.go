...
const columns = `t.id::text,COALESCE(t.target_book_id::text,''),t.original_filename,COALESCE(t.object_key,''),COALESCE(t.object_sha256,''),COALESCE(t.object_byte_size::text,''),t.status,t.quality_status,t.quality_summary,t.total_chapter_count::text,t.imported_chapter_count::text,t.empty_chapter_count::text,t.duplicate_chapter_count::text,t.fail_reason,t.operator_name,t.attempt_count::text,t.max_attempts::text,COALESCE(t.start_time::text,''),COALESCE(t.end_time::text,''),t.created_at::text,t.updated_at::text`
const returningColumns = `id::text,COALESCE(target_book_id::text,''),original_filename,COALESCE(object_key,''),COALESCE(object_sha256,''),COALESCE(object_byte_size::text,''),status,quality_status,quality_summary,total_chapter_count::text,imported_chapter_count::text,empty_chapter_count::text,duplicate_chapter_count::text,fail_reason,operator_name,attempt_count::text,max_attempts::text,COALESCE(start_time::text,''),COALESCE(end_time::text,''),created_at::text,updated_at::text`
