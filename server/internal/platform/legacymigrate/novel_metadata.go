...
func syncIdentitySequence(ctx context.Context, target *sql.Tx, table string) error {
	supported := map[string]bool{
		...
		"novel_authors":                true,
		"novel_books":                  true,
		"novel_crawl_thread_candidate": true,
		"novel_crawl_import_task":      true,
		"novel_crawl_fetch_log":        true,
		"novel_txt_import_task":        true,
		"novel_ai_config":              true,
		"novel_ai_config_model":        true,
