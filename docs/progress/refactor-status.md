...
| M6 全量迁移与校验 | 实施中 | 已实现小说、SEO、Reader、论坛、TXT、AI 配置、章节清洗、章节摘要、作品画像和书籍合并分批 stage/checkpoint；00065 来源键及 JSON 快照映射已加入，清洗/合并对象引用需 MinIO 完整校验，约 8 GB 候选副本已只读定位，完整演练和差异报告仍待完成 |
