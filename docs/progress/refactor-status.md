...
| M5 内容生产与长任务 | 实施中 | 论坛、TXT、清洗、摘要和画像 Worker 恢复与结果唯一性已有真实验证；已新增内容生产 legacy 来源键、论坛全链路、TXT 任务/原文件及 AI 配置/模型迁移 stage，其余清洗结果、合并和 AI 任务映射仍待补齐 |
| M6 全量迁移与校验 | 实施中 | 已实现小说、SEO、Reader、论坛、TXT 和 AI 配置分批 stage/checkpoint；约 8 GB 候选副本已只读定位，TXT 原文件需要显式清单，其他内容生产 stage、对象完整性校验、全量演练和差异报告仍待完成 |
