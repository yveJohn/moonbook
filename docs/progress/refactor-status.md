...
| M5 内容生产与长任务 | 实施中 | 论坛、TXT、清洗、摘要和画像 Worker 恢复与结果唯一性已有真实验证；已新增内容生产 legacy 来源键、论坛全链路、TXT 任务/原文件、AI 配置/模型、章节清洗及书籍合并血缘迁移 stage，AI 摘要/画像映射仍待补齐 |
| M6 全量迁移与校验 | 实施中 | 已实现小说、SEO、Reader、论坛、TXT、AI 配置、章节清洗和书籍合并分批 stage/checkpoint；清洗/合并对象引用需 MinIO 完整校验，约 8 GB 候选副本已只读定位，完整演练和差异报告仍待完成 |
