...
| M4 交易、支付与运营 | 实施中 | 钱包、签到、购买、奖励、运营概览、财务表迁移、EPUSDT 本地创建及每次回调尝试审计已实现；财务全域核对、两个只读运营页签和真实最小金额支付仍待补齐 |
...
- 管理端钱包页面新增“签到记录”“邀请奖励”页签，仅提供查询，不提供补签、补发、删除、重算或资金操作。后端模块编译、前端 ESLint 与生产构建通过；桌面/移动端 E2E 待补。
